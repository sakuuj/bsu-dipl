...
public class FirstKService {
    ...
    public Map<Character, Set<String>> findFirstK(int k, ContextFreeGrammarRequest cfgReq) {
        ...
        Map<Character, Set<String>> prevNonTerminalLangs = new LinkedHashMap<>();
        Map<Character, Set<String>> currentNonTerminalLangs = new LinkedHashMap<>();
        Map<Character, Set<String>> resultNonTerminalLangs = new LinkedHashMap<>();
        nonTerminals.forEach(nt -> {
            currentNonTerminalLangs.put(nt, new LinkedHashSet<>());
            prevNonTerminalLangs.put(nt, new LinkedHashSet<>());
            resultNonTerminalLangs.put(nt, new LinkedHashSet<>());
        });
