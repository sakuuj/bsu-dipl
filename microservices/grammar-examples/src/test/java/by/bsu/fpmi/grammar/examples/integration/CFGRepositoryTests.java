package by.bsu.fpmi.grammar.examples.integration;
...
//
//        // when, then
//        RequestedPage<CFG> cfgPage1 = cfgRepository.selectPage(new PageRequest(1, 2));
//
...
//
//
//        RequestedPage<CFG> cfgPage2 = cfgRepository.selectPage(new PageRequest(2, 2));
//
...
//
//
//        RequestedPage<CFG> cfgPage3 = cfgRepository.selectPage(new PageRequest(3, 2));
//
